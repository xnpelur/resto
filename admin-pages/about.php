<div class="settings-container">
    <form action="../api/set-about.php" method="POST">
        <div class="settings-row">
            ...
            <input type="text" class="form-control" id="about-title" name="about-title" required>
        </div>
        <hr>
        <div class="settings-row">
            <label for="card">Текст</label>
            <textarea class="form-control" id="about-text" name="about-text" rows="8" required></textarea>
        </div>
        <hr>
